...
class StockPredictor:
    ...
    def preprocess_data(self):
        ...
        self.test_data = dataset[self.train_size + self.val_size - self.prediction_days:]
    ...
    def build_model(self):
        ...
        self.model = LSTMModel(input_size=1, hidden_size=128, num_layers=2, output_size=1)
    ...
    def predict(self):
        ...
        plt.plot(prediction_range, predictions, color='red', label='Predicted Stock Price')
...
if __name__ == "__main__":
    ...
    predictor.train(epochs=300, batch_size=64)
    predictor.predict()
    predictor.evaluate()
